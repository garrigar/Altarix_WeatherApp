...
/**
 * Fragment for 1st screen, with current weather in current location
 */
class TodayWeatherFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        inflater.inflate(R.layout.fragment_today_weather, container, false).apply {

            // init views
            txtCityName = this.findViewById(R.id.txt_city_name) as TextView

            imgWeather = this.findViewById(R.id.image_weather) as ImageView

            txtTemp = this.findViewById(R.id.txt_temp) as TextView
            txtDescription = this.findViewById(R.id.txt_description) as TextView
            txtDateTime = this.findViewById(R.id.txt_date_time) as TextView

            txtWind = this.findViewById(R.id.txt_wind) as TextView
            txtPressure = this.findViewById(R.id.txt_pressure) as TextView
            txtHumidity = this.findViewById(R.id.txt_humidity) as TextView
            txtSunrise = this.findViewById(R.id.txt_sunrise) as TextView
            txtSunset = this.findViewById(R.id.txt_sunset) as TextView
            txtGeoCoord = this.findViewById(R.id.txt_geo_coord) as TextView

            weatherPanel = this.findViewById(R.id.weather_panel) as LinearLayout
                ...
                .subscribe(
                    object : Consumer<WeatherResult> {
                        override fun accept(wr: WeatherResult?) {
                            ...
                            wr?.let {
                                ...
                                // load info
                                txtCityName.text = if (it.name.isEmpty()) ""
                                    else StringBuilder(it.name).append(", ", it.sys.country).toString()
                    ...
                    object : Consumer<Throwable> {
                        override fun accept(t: Throwable?) {
                            ...
                            Log.e("TodayWeather Error", t?.message, t)
                        }
                    })
